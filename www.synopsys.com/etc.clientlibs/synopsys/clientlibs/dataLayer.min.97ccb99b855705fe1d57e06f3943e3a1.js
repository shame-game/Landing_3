window.onload = function getPageLoadTime() {
    ...
    $("a").click(function() {
        ...
        if (!cardType) {
            ...
            else if ($(this).closest("div").hasClass("component-nav-list")) cardType = "headerNav";
            else if ($(this).closest("nav").attr("id") == "primary_nav_wrap") cardType = "bottomHeaderNav";
            else if ($(this).closest("div").hasClass("nav-list-header") || $(this).closest("div").hasClass("nav-right-overview-header")) cardType = "topNav";
            else if ($(this).parent().parent().parent().parent().hasClass('subnav-footer-cta')) cardType = "topNav";
            else if ($(this).closest("div").hasClass("component-navLeftMobile")) cardType = "topNav"; // Setting web.webInteraction.region for Mobile TopNav anchor click action
            else if ($(this).closest("li").hasClass("nav-left-item")) cardType = "topNav";
            else cardType = "body";
        }
        if (!hier) hier = "";
        if (!level) level = "";
        ...
        if ($(this).closest("section").attr("class") == "component-author-profile") {
         ...
         /* Setting web.webInteraction.region for Topnav caret-up close button anchor click action*/
         if ($(this).attr("class") == "close-button") {
            replaced2 = "close button"
            cardType = "topNav";
        }
        /* Setting web.webInteraction.region for TopnavAd anchor click action*/
        if ($(this).parents("section.component-topNavAd").length > 0) {
            cardType = "topNav";
        }
        /* Setting web.webInteraction.region for SIG  Topnav bottom anchor click action*/
        if ($(this).closest("section").closest("nav").hasClass("SIG-Sub-dropdown")) {
            cardType = "bottomHeaderNav";
        }
        if ($(this).closest("nav").hasClass("SIG-Main")) {
            cardType = "topNav";
        }
        ...
        if ($(this).closest("section").hasClass("cmp-dynamiccards")) {
         ...
         /* Setting web.webInteraction.region for mobile nav Contact sales anchor click action*/
         if ($(this).closest("li").attr("id") == "extrabtnmobile") {
            cardType = "topNav";
        }
